...
def analyze_esc_filter(filter_id="18891"):
    """Analyze all issues in ESC filter with detailed breakdown"""
    jira = JiraRestApi()
...
def main():
    """Main function for ESC filter analysis"""
    parser = argparse.ArgumentParser(description="Analyze ESC filter with detailed breakdown")
    parser.add_argument('-f', '--filter-id', default='18891', help='ESC filter ID (default: 18891)')
    args = parser.parse_args()
    
    return analyze_esc_filter(args.filter_id)
